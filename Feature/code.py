...
res_pen_pressure = pen_pressure_detection('./three.jpeg')
res_text_size = text_size('./three.jpeg')
res_slant_of_baseline = slant_of_baseline('./three.jpeg')
res_word_spacing = word_spacing('./three.jpeg')
...
print(penPressure, baselineStraight, wordSizeNormal, wordSizeSmall, wordSpacing)
...
print('Emotion : ', model_emo.predict(
    [[penPressure, baselineStraight, wordSizeNormal, wordSizeSmall, wordSpacing]]))

print('Attention : ', model_att.predict(
    [[penPressure, baselineStraight, wordSizeNormal, wordSizeSmall, wordSpacing]]))

print('Optimism : ', model_opt.predict(
    [[penPressure, baselineStraight, wordSizeNormal, wordSizeSmall, wordSpacing]]))
